function formatOutput(currTok, tokValue, startTok, tokenizer) {
    const output = {token: currTok, value: tokValue, start: startTok};
...
module.exports = function (aString, tokenizer) {
        ...
        while (aString) {
            ...
            if (!tokenizer.ignore[currTok]) {
                tok.push(formatOutput(currTok, tokValue, currentPos+startTok, tokenizer));
            }
